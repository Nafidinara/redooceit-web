        ...
        <section id="content-types">
            <div class="row">
                            ...
                            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="assets/static/images/samples/architecture1.jpg" class="d-block w-100"
                                            alt="Image Architecture">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="assets/static/images/samples/bg-mountain.jpg" class="d-block w-100"
                                            alt="Image Mountain">
                                    </div>
                                    <div class="carousel-item">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="card">
                        <div class="card-content">
                            <img class="card-img-bottom img-fluid" src="assets/static/images/samples/building.jpg"
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="card">
                        <div class="card-content">
                            ...
                            <img class="card-img-bottom img-fluid" src="assets/static/images/samples/water.jpg"
                                alt="Card image cap" style="height: 20rem; object-fit: cover;">
                        </div>
                    </div>
                </div>
